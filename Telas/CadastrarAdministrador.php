<?php
    ...
    use PHP\JoaoRoncon\Administrador;
...
<html>
    ...
    <body>
    <a  href="MenuAdministradorAdm.php">
    ...
    <p class="title">Cadastrar Administrador</p>
    <form class="form">
        <div class="input-row">
        ...
        <button class="sign">Cadastrar
            <?php
                ...
                if(isset($_POST['tNome'])){
                    ...
                    $senha = $_POST['tSenha'];
                $inserir = new Inserir();
                echo $inserir->cadastrarAdministrador($conexao,$cpf,$nome,$nomeSocial,$genero,$pronome,$email,$telefone,$dtNascimento,$senha);
                }
            ?>
        </button>
    </form>
